...
const Template = (args) => {
    ...
    return (_jsxs(PanelLeft, { panelWidth: clampedWidth, panelResize: args.panelResize, children: [_jsxs(PanelLeftToolbar, { panelIcon: _jsx(Cube20Filled, {}), panelTitle: "Panel Left", children: [_jsx(Button, { appearance: "subtle", icon: _jsx(Add20Regular, {}) }), _jsx(Button, { appearance: "subtle", icon: _jsx(MoreHorizontalRegular, {}) })] }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px', padding: '0 16px 16px 16px' }, children: Array.from({ length: args.childrenSample }).map((_, index) => (_jsx("div", { children: _jsxs("div", { style: {
                            display: "flex",
